            ...
            <div class="row">            
                <div class="login-container col-lg-4 col-md-6 col-sm-8 col-xs-12">
                        ...
                        <div class="login-body">
                            <form role="form" action="" method="post" class="login-form">
                                <div class="form-group ">
                                    <div class="pos-r">                                        
                                        <input type="text" name="nom" id="nom" placeholder="Name..." class="form-username form-control">
                                ...
                                <div class="form-group ">
                                    <div class="pos-r">                                        
                                        <input type="text" name="prenom" id="prenom" placeholder="first Name..." class="form-username form-control">
                                        <i class="fa fa-user"></i>
                                        <span></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <div class="pos-r">                                    
                                        <input type="password" name="password2" id="password" placeholder="Confirm Password..." class="form-password form-control" >
                                        <i class="fa fa-lock"></i>
                                        <span></span>                                        
                                    </div>
                                </div>
                                <div class="form-group">     
                                    <button type="submit" class="btn btn-warning form-control"><strong>Sign up</strong></button>
                                </div>   
                    ...
                    <div class="login-footer text-center template">
                        <h5>Do you have an account?<a href="<?php echo base_url('auth/login'); ?>" class="bold"> Sign in </a>     </h5>
